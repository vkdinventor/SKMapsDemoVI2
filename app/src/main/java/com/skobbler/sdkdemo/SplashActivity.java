...
import com.skobbler.sdkdemo.ApplicationPreferences;
import com.skobbler.sdkdemo.DemoApplication;
...
public class SplashActivity extends Activity implements SKPrepareMapTextureListener, SKMapUpdateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (applicationPath != null) {
            ...
            Log.v("TAG_VI"," mapresources path ="+mapResourcesDirPath);
        } else {
    ...
    public static String chooseStoragePath(Context context) {
        if (getAvailableMemorySize(Environment.getDataDirectory().getPath()) >= 500 * MEGA) {
            if (context != null && context.getFilesDir() != null) {
                return context.getFilesDir().getPath();
            }
        } else {
            if ((context != null) && (context.getExternalFilesDir(null) != null)) {
                if (getAvailableMemorySize(context.getExternalFilesDir(null).toString()) >= 500 * MEGA) {
